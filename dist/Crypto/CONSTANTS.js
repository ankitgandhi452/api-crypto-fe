...
exports.RSA_CONSTANTS = exports.AES_256_GCM_CONSTANTS = void 0;
var RSA_CONSTANTS = {
  ALGORITHM: 'RSA-OAEP',
...
var AES_256_GCM_KEY_LENGTH = 32;
var AES_256_GCM_KEY_BIT_LENGTH = AES_256_GCM_KEY_LENGTH * 8;
var AES_256_GCM_KEY_STRING_LENGTH = 4 * Math.ceil(AES_256_GCM_KEY_BIT_LENGTH / 3);
var AES_256_GCM_CONSTANTS = {
  ALGORITHM: 'AES-GCM',
  ...
  ERRORS: {
    ...
    INVALID_KEY_STRING_LENGTH: {
      message: "'key' must be of length ".concat(AES_256_GCM_KEY_STRING_LENGTH),
...
exports.AES_256_GCM_CONSTANTS = AES_256_GCM_CONSTANTS;